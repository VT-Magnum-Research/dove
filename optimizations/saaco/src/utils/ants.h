...
#ifndef __AntHybrid__ants__
#define __AntHybrid__ants__
...
class ACSAnt : public Ant {
  ...
  public:
    ...
    void initial_offline_pheromone_update(PheromoneMatrix* pheromones, double pheromone);
    void construct_solution(OptimizationProblem &op, PheromoneMatrix &pheromones, double alpha, double beta);
    ...
    void offline_add_vertex_to_tour(unsigned int vertex);
};
...
protected:
  ...
  void set_local_search_type(AntColonyConfiguration::LocalSearchType ls) {
    local_search_type_ = ls;
  }
    ...
    // If you really know what you're doing, you can modify me! YMMV
    P* get_pheromone_matrix() {
      return pheromones_;
    }
